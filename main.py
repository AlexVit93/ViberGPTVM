...
# token_lock = Lock()  # Create a lock for thread safety

# # Define the route for incoming webhook requests
...
#     # Use a lock to safely check and update the last processed message token
#     with token_lock:
